### Source Code for Full Test Data ###

library(car)
library(data.table)
library(datasets)

### Replace the test file name###
...
#removing negative fit constraint
...
solution= data.frame(station,timestamp,bikes)
print(solution)
write.csv(solution, file = "Arun_BS_Prediction_Full.csv",row.names=FALSE)
